...
[[file:odin/assignments/foundations/odin-links-and-images/about.html][odin/assignments/foundations/odin-links-and-images/about.html]] ≡

#+begin_src html :tangle odin/assignments/foundations/odin-links-and-images/about.html
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
Now we update the *href*.
It's a good practice to start the reference with "./", it may prevent some errors.
